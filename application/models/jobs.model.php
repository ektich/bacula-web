 ...
 */
 ...
 class Jobs_Model extends DatabaseModel
 {
    // ==================================================================================
    // Function: 	count()
    ...
    public function count_Jobs($period_timestamps, $job_status = null, $job_level = null)
    {
        ...
        // Check PDO object
        if( !is_a( $this->dbadapter->db_link, 'PDO') and is_null($this->dbadapter->db_link)  )
            throw new Exception('Unvalid PDO object provided in count_Jobs() function');

        // Getting timestamp interval
        $intervals  = CDBQuery::get_Timestamp_Interval( $this->dbadapter, $period_timestamps );
